...
module.exports = {
  ...
  grey: '#808080',
  white: '#ffffff',
  generate: (params, theme) => {
    const tokens = {
      comments: params.comments,
      flowControl: params.flowControl,
      variableNames: params.variableNames,
      languageConstants: params.languageConstants,
      constants: params.constants,
      htmlTags: params.htmlTags,
      types: params.types,
      variableDeclarators: params.variableDeclarators,
      typeModifiers: params.typeModifiers,
    ...
    Object.keys(tokens).forEach(token => {
      kookDefault.tokenColors.find(x => x.name == token).settings.foreground = tokens[token];
    });
  
    kookDefault.colors["statusBar.background"] = theme;
    kookDefault.colors["tab.activeBorder"] = theme;
  
    fs.writeFileSync('./themes/kook.json', JSON.stringify(kookDefault, null, 2));
  }
};